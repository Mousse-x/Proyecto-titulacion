...
class UniversityEvaluationSummary(models.Model):
    ...
    national_index           = models.DecimalField(max_digits=6, decimal_places=2, default=0)
    international_index      = models.DecimalField(max_digits=6, decimal_places=2, default=0)
    integrated_index         = models.DecimalField(max_digits=6, decimal_places=2, default=0)
    international_average_score = models.DecimalField(max_digits=8, decimal_places=2, default=0)
    international_max_score     = models.DecimalField(max_digits=8, decimal_places=2, default=0)
    evaluated_documents      = models.PositiveIntegerField(default=0)
